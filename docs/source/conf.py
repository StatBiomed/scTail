...
#notebooks_url = "https://github.com/StatBiomed/scTail/blob/main/notebook/runBRIE.ipynb"
#notebooks= [
#    "runBRIE.ipynb"
#]
#for nb in notebooks:
#    try:
#        requests.get(notebooks_url)
#    except:
#        raise ValueError(f'{nb} cannot be retrieved.')
...
#import requests
#notebooks=[requests.get(notebooks_url)
...
#import unitvelo
#version = unitvelo.__version__ #'0.1.3' #
...
latex_documents = [
  ('index', 'scTail.tex', u'scTail Documentation',
   u'Ruiyan Hou', 'manual'),
]
...
man_pages = [
    ('index', 'scTail', u'scTail Documentation',
     [u'Ruiyan Hou'], 1)
]
...
texinfo_documents = [
  ('index', 'scTail', u'scTail Documentation',
   u'Ruiyan Hou', 'scTail', 'One line description of project.',
   'Miscellaneous'),
]
